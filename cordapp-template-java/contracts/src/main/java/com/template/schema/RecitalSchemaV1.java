...
public class RecitalSchemaV1 extends MappedSchema {

    /**
     * The constructor of the MappedSchema requires the schemafamily, verison, and a list of all JPA entity classes for
     * the Schema.
     */
    public RecitalSchemaV1() {
        super(RecitalSchemaFamily.class, 1, ImmutableList.of(PersistentJCT.class,
                PersistentCondition.class));
    }
}
