...
public class RecitalMap {
    private final static HashMap<Integer, JCTRecital> hm = new HashMap<>();
    ...
    public static List<JCTRecital> getRecitalsFor(List<Integer> recitals) {
        // Recital 1
        ...
        hm.put(1, JCTRecital.createWithNoDetails(1, recital1));
        ...
        hm.put(2, JCTRecital.createWithNoDetails(2, recital2));
        ...
        hm.put(3, JCTRecital.createWithNoDetails(3, recital3));
        ...
        hm.put(4, JCTRecital.createWithNoDetails(4, recital4));
        ...
        hm.put(5, JCTRecital.createWithNoDetails(5, recital5));
        ...
        hm.put(6, JCTRecital.createWithNoDetails(6, recital6));
        ...
        hm.put(7, JCTRecital.createWithNoDetails(7, recital7));

        // Recital 8
        String recital8 = "whether any of Supplemental Provisions 1 to 6 and 9 apply is stated in the Contract Particulars;";
        hm.put(8, JCTRecital.createWithNoDetails(8, recital8));

        // TODO - Recitals 9 to 12.


        // Returns Set view
        Set<Map.Entry<Integer, JCTRecital>> st = hm.entrySet();

        for(Map.Entry<Integer, JCTRecital> me:st) {
            System.out.print(me.getKey() + ":");
            System.out.println(me.getValue());
        }

        List<JCTRecital> result = recitals.stream()
